      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center space-y-3">
          ...
          <p className="text-sm text-slate-400">
            Tell us who you are so Jarvis can tailor insights to your portfolio.
          </p>
        </div>
          ...
          <div className="rounded-2xl border border-slate-800 bg-slate-900/70 p-6 space-y-4 shadow-[0_10px_35px_rgba(8,15,40,0.45)]">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-slate-500">
                Jarvis adapts dashboards to match your role and objectives.
              </p>
            </div>
            ...
            <div>
              ...
              />
              <p className="mt-1 text-xs text-slate-500">
                A short handle Jarvis can use to reference this portfolio.
              </p>
            </div>
          </div>
        ...
        <div className="mt-6">
          ...
          <div className="mt-4 text-center text-sm text-slate-400">
            ...
            <ul className="mt-2 space-y-1">
              ...
              <li>• AI-guided allocation ideas from Jarvis + Gemini</li>
